...
interface DashboardProps {
  ...
  onOpenStaffManagement: () => void; // <--- Naya prop add kiya gaya hai
}
...
export const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  const staffList = useAppSelector((state: any) => state.staff?.staffList || []); // <--- Yeh line lazmi add karein
  ...
  const netBalance = totalFeeCollected - totalSalariesAndExp; 
   return (
    ...
    <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap', width: '100%' }}>
      ...
      {/* --- Naya Staff Management Button (Calculator ke barabar ya top bar mein) --- */}
          </div>
    ...
    {/* Yahan component ko render karwa dein */}
